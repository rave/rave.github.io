...
$(document).ready(function() {
  ...
  $(".page-clients .arrow-left-dark").on('click', function() {
  	if ($(this).hasClass("inactive")){
  		return false;
  	}
  	else {
  		$(this).addClass("inactive");
  		$(".page-clients .arrow-right-dark").removeClass("inactive");
      $(".page-clients .logos-block").css("left", function(){
        return parseInt($(this).css("left")) + $(".page-clients").width();
      });
      clients_page -= 1;
      if (clients_page < 4) {
  			timeoutID = window.setTimeout(function(){$(".page-clients .arrow-left-dark").removeClass("inactive")}, 500);
        $(".page-clients .arrow-right-dark").removeClass("hidden");
      };
      if (clients_page == 1) {
  			window.clearTimeout(timeoutID);
        $(".page-clients .arrow-left-dark").addClass("hidden");
      }
  	}
  });

  $(".page-clients .arrow-right-dark").on('click', function() {
  	if ($(this).hasClass("inactive")){
  		return false;
  	}
  	else {
  		$(this).addClass("inactive");
  		$(".page-clients .arrow-left-dark").removeClass("inactive");
      $(".page-clients .logos-block").css("left", function(){
        return parseInt($(this).css("left")) - $(".page-clients").width();
      });
      clients_page += 1;
      if (clients_page > 1) {
        $(".page-clients .arrow-left-dark").removeClass("hidden");
  			timeoutID = window.setTimeout(function(){$(".page-clients .arrow-right-dark").removeClass("inactive")}, 500);
      };
      if (clients_page > 3) {
  			window.clearTimeout(timeoutID);
        $(".page-clients .arrow-right-dark").addClass("hidden");
      }
  	}
  });
